...
(function () {
    ...
    function collectHighlightedLayerItems(layers) {
        ...
        for (i = 0; i < layers.length; i += 1) {
            collectLayerItemsRecursive(layers[i], result);
        }
    ...
    function collectLayerItemsRecursive(layer, store) {
        ...
        for (i = 0; i < layer.pageItems.length; i += 1) {
            addUniqueItemReference(store, layer.pageItems[i]);
        }

        for (i = 0; i < layer.layers.length; i += 1) {
            collectLayerItemsRecursive(layer.layers[i], store);
        }
    }

    function addUniqueItemReference(store, item) {
        var i;
