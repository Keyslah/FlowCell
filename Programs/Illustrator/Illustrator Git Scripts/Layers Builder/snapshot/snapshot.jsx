...
function FlowCellSnapshotHasNativeSelection() {
...
var FLOWCELL_LB_TARGETS = FlowCellSnapshotResolveTargets();
...
(function () {
    ...
    function resolveTargets(documentRef) {
        ...
        if (result.length > 0 || layers.length > 0) {
            logLine("Target count after Layer Tree resolution: " + result.length);
            return result;
        }

        selection = normalizeSelection(documentRef.selection);
