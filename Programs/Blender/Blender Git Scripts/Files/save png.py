# Description: Render the active selected object from the current scene camera into this project's PNG folder as a transparent PNG cropped exactly to the visible object bounds.
...
ACTION_NAME = "render_active_object_png_to_images"
