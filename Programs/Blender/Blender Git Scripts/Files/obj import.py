...
OPERATOR_ID = "flowcell.import_obj_fix_transform"
OPERATOR_CLASS_NAME = "FLOWCELL_OT_import_obj_fix_transform"
...
class FLOWCELL_OT_import_obj_fix_transform(bpy.types.Operator, ImportHelper):
