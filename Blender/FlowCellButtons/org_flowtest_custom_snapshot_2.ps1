...
# Source Bridge Action: flowtest_custom_snapshot_2
# Source Python Filename: flowtest_custom_snapshot_2.py
# Source Python File: D:\Dev\workspace\Codex\FlowTest\Blender\ManagedActions\flowtest_custom_snapshot_2.py
...
& $dispatcherPath -Action 'flowtest_custom_snapshot_2' -Label 'snapshot'
exit $LASTEXITCODE
