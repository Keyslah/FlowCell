...
# Source Bridge Action: flowtest_custom_snapshot_3
# Source Python Filename: flowtest_custom_snapshot_3.py
# Source Python File: D:\Dev\workspace\Codex\FlowTest\Blender\ManagedActions\flowtest_custom_snapshot_3.py
...
& $dispatcherPath -Action 'flowtest_custom_snapshot_3' -Label 'snapshot'
exit $LASTEXITCODE
