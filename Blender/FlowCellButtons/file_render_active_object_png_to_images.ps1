...
# Source Bridge Action: render_active_object_png_to_images
...
#     temp_file = tempfile.NamedTemporaryFile(prefix="flowtest_render_", suffix=".png", delete=False)
