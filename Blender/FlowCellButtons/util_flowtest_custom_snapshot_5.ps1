...
# Source Bridge Action: flowtest_custom_snapshot_5
# Source Python Filename: flowtest_custom_snapshot_5.py
# Source Python File: D:\Dev\workspace\Codex\FlowTest\Blender\ManagedActions\flowtest_custom_snapshot_5.py
...
& $dispatcherPath -Action 'flowtest_custom_snapshot_5' -Label 'snapshot'
exit $LASTEXITCODE
