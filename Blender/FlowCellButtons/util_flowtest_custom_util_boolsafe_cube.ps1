# Description: Add a Boolean-safe cube using the original low poly objects defaults and cleanup steps.
...
& $dispatcherPath -Action 'flowtest_custom_util_boolsafe_cube' -Label 'util_boolsafe_cube'
exit $LASTEXITCODE
