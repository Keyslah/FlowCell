...
# Source Bridge Action: flowtest_custom_snapshot_7
# Source Python Filename: flowtest_custom_snapshot_7.py
# Source Python File: D:\Dev\workspace\Codex\FlowTest\Blender\ManagedActions\flowtest_custom_snapshot_7.py
...
& $dispatcherPath -Action 'flowtest_custom_snapshot_7' -Label 'snapshot'
exit $LASTEXITCODE
