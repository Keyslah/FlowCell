...
# Source Bridge Action: flowtest_custom_snapshot
# Source Python Filename: flowtest_custom_snapshot.py
# Source Python File: D:\Dev\workspace\Codex\FlowTest\Blender\ManagedActions\flowtest_custom_snapshot.py
...
& $dispatcherPath -Action 'flowtest_custom_snapshot' -Label 'snapshot'
exit $LASTEXITCODE
