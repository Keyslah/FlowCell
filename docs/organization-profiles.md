...
- Only **one folder is selected at a time** across the Project tree and the profile section — selecting a folder in one tree clears the other. Clicking a folder in **either** tree shows that folder's assigned roles/folders in the editor on the right (so you can view and edit a profile folder's assignments too). Disk-only actions — Add Folder, Delete folder under the project tree, and Apply profile — stay scoped to the project tree.
